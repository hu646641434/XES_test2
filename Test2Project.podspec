...
Pod::Spec.new do |s|
  ...
  s.version      = "0.0.1"
  #pod简介(最多140字符)
  s.summary      = "Test2Project."
  #pod详细描述
  s.description  = <<-DESC
                    this is Test2Project develop by xueersi Base component library team
                   DESC
  #项目主页地址
  s.homepage     = "https://github.com/hu646641434/XES_test2.git"
  ...
  #库索引地址
  s.source       = { :git => "https://github.com/hu646641434/XES_test2.git", :tag => s.version.to_s }

  #需要包含的源文件
  s.source_files  = "Test2Project/**/*.{h,m}"
  #需要移除的文件
